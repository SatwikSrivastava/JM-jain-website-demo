<?php 
	...
	function clean($string) {
      ...
      return preg_replace('/[^A-Za-z0-9\-]/', '', $string);
       ...
       if(isset($_GET['Action']) && $_GET['Action']=="UpdateStatus"){
        ...
        $sql=mysqli_query($con, "UPDATE `banner` SET status='$status' WHERE b_id='$id' ")or die(mysqli_error($con));
    
        header('location:banner.php?msg=success');
        ...
        if($img<>"")

            {
              ...
              $newName = $prefix ."-". substr(md5(rand() * time()), 0, 5) . $ext;
               ...
               move_uploaded_file($tmpName,"banner/".$newName);

            }
        

		mysqli_query($con,"INSERT INTO `banner` (b_title,b_details,images,date_reg) VALUES ('$title','$short_details','$newName',now())") or die(mysqli_error($con));
		header('location:banner.php?msg=Insert Data Successfully');
	}
    ...
    //      header('location:banner.php?msg=Comment Data save');
    // }
	...
	if(isset($_POST["Update"])) {
        ...
        mysqli_query($con,"UPDATE banner SET b_title='$title',b_details='$short_details',images='$newName' WHERE b_id='$id'") or die(mysqli_error($con));
        header('location:banner.php?msg=Update Successfully');
    }


    if(isset($_REQUEST['remove']) && $_REQUEST['remove']=="yes"){

        $sqlp=mysqli_query($con,"select * from banner where b_id='$_REQUEST[id]'");
        ...
        mysqli_query($con, "delete from banner where id='$_REQUEST[id]'");   
     
        header("location:banner.php?msg=Deleted Successfully");
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <?php	
                            ...
                            $id2=$_GET['id'];
                            $sql2="select * from banner where b_id='$id2'";
                        ...
                        <div class="card mb-4">
                            ...
                            <form class="card-body" method="post" action="">
                                <h6 class="fw-normal">Banner Details</h6>
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label class="form-label">Title</label>
                                        <input type="text" name="title" id="title" value="<?php echo $row1['b_title'];?>" class="form-control"
                                            placeholder="john.doe" />
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Image</label>
                                        <img src="banner/<? echo $row1['images']; ?>" width="100">
                                    ...
                                    <div class="col-md-12">                                        
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            placeholder="Short Details" aria-label="Short Details"><?php echo $row1['b_details'];?></textarea >
                                        </div>
                                    </div>
                                </div>          
                                
                                <div class="pt-4">
                                    <input type="hidden" value="<?php echo $row1['b_id'];?>" name="id">
                        ...
                        if(isset($_GET['Action']) && $_GET['Action']=="Show"){  
                            $id2=$_GET['id'];
                            $stmt="select * from banner where b_id='$id2'";
                        ...
                        <div class="card mb-4">
                            ...
                            <form class="card-body" method="post" action="">
                                ...
                                <hr class="my-4 mx-n4" />
                                <h6 class="fw-normal">2. Banner Info</h6>
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label class="form-label" >Title</label>
                                        <input type="text" name="title" value="<?php echo $row1['b_title'];?>" id="title" class="form-control"
                                            placeholder="Title" />
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Image</label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea type="text" name="short_details" id="short_details" class="form-control"
                                            placeholder="Short_details"><?php echo $row1['b_details'];?></textarea>
                                    </div>                                                                
                                </div>
                                
                                <div class="pt-4">
                                    <input type="hidden" value="<?php echo $row1['b_id'];?>" name="id">
                                    <input type="hidden" value="<?php echo $row1['b_title'];?>" name="id">
                        ...
                        <h4 class="py-3 breadcrumb-wrapper mb-4">
                            <span class="text-muted fw-light">Banner /</span> Task List 
                        </h4>
                        ...
                        <div class="card">
                            ...
                            <div class="btn-group">
                                <div class="buttonexport" id="buttonlist">
                                    <h5 class="card-header">Banner Management</h5><a class="btn btn-primary" href="banner.php?Action=Add" style="margin:15px;">Add Banner</a>
                                </div>
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            <td><?php echo $i++;?></td>
                                            <td><strong><?php echo $row3['b_title'];?></strong></td>
                                            <td><img src="banner/<?php echo $row3['images']; ?>" width="100"></td>
                                            
                                            <td>
                                                <? if($row3['status']=="Active"){ ?>
                                                <a href="banner.php?Action=UpdateStatus&id=<?php echo $row3['b_id']; ?>&status=Inactive" class="btn btn-outline-success"><?php echo $row3['status']; ?></a>
                                                <? } else { ?>
                                                <a href="banner.php?Action=UpdateStatus&id=<?php echo $row3['b_id']; ?>&status=Active" class="btn btn-warning"><?php echo $row3['status']; ?></a>
                                                <? } ?>
                                            </td>
                                            <td>
                                                <a href="banner.php?Action=Update&id=<?php echo $row3['b_id'];?>" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="javascript:resume_id('<?php echo $row3['b_id'];?>')" class="btn btn-outline-danger"><i class="fa-solid fa-trash-can"></i></a>
                                                <a href="banner.php?Action=Show&id=<?php echo $row3['b_id']?>" class="btn btn-outline-info"><i class="fa-solid fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                        } 
